...
//				"$base_dir/code/3rdparty/InnovaStudio/scripts/innovaeditor.js",
			...
			ProductionBuilder::buildProductionJS($js_list, "$base_dir/code/js/prod_posts.js", DO_MINIFY);
			ProductionBuilder::buildProductionCSS($css_list, "$base_dir/code/css/prod_posts.css", DO_MINIFY);
