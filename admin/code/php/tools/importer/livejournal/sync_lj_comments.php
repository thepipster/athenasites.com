...
define('DB_NAME', 'charlou7_blog');    // The name of the database
define('DB_USER', 'charlou7_wpuser');     // Your MySQL username
define('DB_PASSWORD', 'rubies'); // ...and password
...
curl_setopt($ch, CURLOPT_COOKIEFILE, $_SERVER['DOCUMENT_ROOT'].'/wp-content/plugins/lj_comments_import/cookie.txt'); //get cookie from file
curl_setopt($ch, CURLOPT_COOKIEJAR, $_SERVER['DOCUMENT_ROOT'].'/wp-content/plugins/lj_comments_import/cookie.txt');
...
$user = get_wp_option('lj_comments_username');
$pass = get_wp_option('lj_comments_pass');
