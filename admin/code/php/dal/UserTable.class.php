...
class UserTable {
    ...
    public static function getNumberUsers() {
        return DatabaseManager::getVar("SELECT COUNT(id) AS no FROM athena_Users");
    }
    ...
    public static function getUsersFromSiteID($site_id) {
        $sql = DatabaseManager::prepare("SELECT * FROM athena_UserToSite uts INNER JOIN athena_Users u
