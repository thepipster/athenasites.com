...
var thebeBlog = {
    ...
    init : function(){
        ...
        thebeBlog.m_commandURL = 'http://' + location.host + '/admin/code/php/remoteapi/BlogAPI.php';
    
        // Get the comments
        thebeBlog.getComments();
		...
		$.validator.addMethod(
			"required_email", function(value, element) { 
		  		...
		  		return thebeBlog.checkEmail(value);
			}, 
			"Enter a valid email");
        ...
        thebeBlog.onResize();
        setTimeout("thebeBlog.onResize()", 200);
    ...
    getComments : function(){
        ...
        var paras = {
            ...
            site_id: thebeBlog.m_siteID,
            post_id: thebeBlog.m_postID
        };

        $.ajax({
            url: thebeBlog.m_commandURL,
            dataType: "json",
            data: paras,
            success: thebeBlog.onGotComments
        });
    ...
    onPostComment : function(){
		...
		if ($("#commentForm").valid()){
	        ...
	        $.ajax({
	            ...
	            dataType: "json",
	            data: paras,
	            success:  thebeBlog.onCommentPosted,
