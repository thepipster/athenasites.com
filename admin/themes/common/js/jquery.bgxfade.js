...
var containerObjList = new Array();
var center = 0;

(function($) {

	// plugin definition
	$.fn.bgXfade = function(cntr) {
		...
		/*
		var images = $(containerObj).children('img');
		
		// Hide all the images except the first
		if (images.length > 1){
			$(containerObj).children('img').hide();
			$(images[0]).show();	
		}
		*/
		
		containerObjList.push(containerObj);
