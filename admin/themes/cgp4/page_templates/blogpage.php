...
?>
	...
	<div id='blogPage' class='pageContents' style="background-image:url('')">
		...
		<p class=''>
			...
			<a href="http://del.icio.us/post?url=<?= $post_link ?>&title=<?= $post_title; ?>" target='_blank' title='Del.icio.us'>
			...
			<a href="http://del.icio.us/post?url=<?= $post_link ?>&title=<?= $post_title; ?>" target='_blank' title='Del.icio.us'>Del.icio.us</a> 
			
			&nbsp;&nbsp;
		
			<!-- DIGG //////////////////////////////////////////////////////////////////////// --> 
			
			<a href="http://www.digg.com/submit?url=<?= $post_link ?>&title=<?= $post_title; ?>&phase=2" target='_blank' title='Digg'>
			...
			<a href="http://www.digg.com/submit?url=<?= $post_link ?>&title=<?= $post_title; ?>&phase=2" target='_blank' title='Digg'>Digg</a> 
		
			&nbsp;&nbsp;
			
			<!-- FACEBOOK //////////////////////////////////////////////////////////////////////// --> 
			
			<a href="http://www.facebook.com/share.php?u=<?= $post_link ?>" target='_blank' title='Facebook'>
			...
			<a href="http://www.facebook.com/share.php?u=<?= $post_link ?>" target='_blank' title='Facebook'>Facebook</a> 
			
			&nbsp;&nbsp;
			
			<!-- STUMBLE UPON //////////////////////////////////////////////////////////////////////// --> 
			
			<a href="http://www.stumbleupon.com/submit?url=<?= $post_link ?>&title=<?= $post_title; ?>" target='_blank' title='StumbleUpon'>
			...
			<a href="http://www.stumbleupon.com/submit?url=<?= $post_link ?>&title=<?= $post_title; ?>" target='_blank' title='StumbleUpon'>StumbleUpon</a> 
			
			&nbsp;&nbsp;
			
			<!-- TECHNORATI //////////////////////////////////////////////////////////////////////// --> 
			<!--
			<a href="http://technorati.com/cosmos/search.html?url=<?= $post_link ?>" target='_blank' title='Technorati'>
			...
			<a href="http://technorati.com/cosmos/search.html?url=<?= $post_link ?>" target='_blank' title='Technorati'>Technorati</a> 
			
			&nbsp;&nbsp;
			-->
			<!-- TWITTER //////////////////////////////////////////////////////////////////////// --> 
			
			<a href="http://twitter.com/home/?status=Currently reading:<?= $post_link ?>" target='_blank' title='Twitter'>
			...
			<a href="http://twitter.com/home/?status=Currently reading:<?= $post_link ?>" target='_blank' title='Twitter'>Twitter</a>
