				...
				jQuery(this).mousedown( function(e) {
					...
					jQuery(this).mouseup( function(e) {
						...
						if( evt.button == 2 ) {
							...
							/*
							This is crap and doesn't work.... mjp
							var d = {}, x, y;
							if( self.innerHeight ) {
							...
							*/
							...
							// MJP edit...correct for offsets (WP adds offsets, so the reported mouse position is wrong
							...
							//alert(e.pageX + ", " + e.pageY + " pos = " + pos.left + ", " + pos.top + "  offsets = " + offset.left + ", " + offset.top);
							// End MJP edit...
