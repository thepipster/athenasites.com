...
<head profile="http://gmpg.org/xfn/11">
	...
	<link rel="stylesheet" href="<?php bloginfo('stylesheet_directory'); ?>/callisto-min.css" type="text/css" media="screen" />
	
	<!-- JS Includes ///////////////////////////////////////////////////// -->

	<script type="text/javascript" src="<?php bloginfo('stylesheet_directory'); ?>/js/callisto-min.js"></script>
