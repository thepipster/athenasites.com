...
//									echo "<img id='miniImage' src='$image_url' title='$image_title' alt='$image_alt' width='100%'/>";
					...
					<td width="50%" valign="top">
						<div class='infoPageText'>
							...
							<form id='contactForm' method='post' action='' onsubmit="return pandoraContactPage.onSubmit();">
								<input type="text" class='inputText required_name' id='name' name='name' value="Your Name" onfocus="if (this.value == 'Your Name'){this.value = '';}" onblur='pandoraContactPage.onChange()'>
								<input type="text" class='inputText required_email' id='email' name='email' value="Your E-mail Address" onfocus="if (this.value == 'Your E-mail Address'){this.value = '';}" onblur='pandoraContactPage.onChange()'>
								<input type="text" class='inputText required_phone' id='phone' name='phone' value="Your Phone" onfocus="if (this.value == 'Your Phone'){this.value = '';}" onblur='pandoraContactPage.onChange()'>
								<input type="text" class='inputText' id='location' name='location' value="Event Location" onfocus="if (this.value == 'Event Location'){this.value = '';}" onblur='pandoraContactPage.onChange()'>
								...
								<!-- <button onclick="pandoraContactPage.onSubmit()">Submit</button> -->
							</form>
