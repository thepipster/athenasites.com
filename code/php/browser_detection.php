...
function browser_detection( $which_test, $test_excludes='', $browser_user_agent='' ) 
{
	//error_log("browser_detection( $which_test, $test_excludes, $browser_user_agent )");
	...
	if ( !$b_repeat )
	{
		...
		*/
		if ($browser_user_agent == ''){
			...
			//error_log("Getting from _SERVER, user agent = $browser_user_agent");
		}
